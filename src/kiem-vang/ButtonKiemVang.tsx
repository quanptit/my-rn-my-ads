...
import {Button, ButtonModel, ButtonProps, DialogUtils, Spinner, Toast} from "my-rn-base-component";
...
export class ButtonKiemVang extends Component<Props, { isLoading }> {
